...
print("Number of Males {}".format(dataset[dataset.label == 'male'].shape[
                                      0]))  # shape returns the dimensions of the array. If Y has n rows and m columns, then Y.shape is (n,m). So Y.shape[0] is n.
...
print(
    "Accuracy of Decision Tree Classification: {}".format(metrics.accuracy_score(y_test, y_pred)))  # 0.9463722397476341
...
print(
    "Accuracy of Random Forest Classification: {}".format(metrics.accuracy_score(y_test, y_pred)))  # 0.9779179810725552
